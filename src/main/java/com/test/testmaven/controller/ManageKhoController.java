 ...
 * @author Admin
 */
public class ManageKhoController {
    ...
    public ManageKhoController(JButton btnSubmit, JTextField jtfNamThang, JTextField jtfTongSLNhap, JTextField jtfTongSLXuat, JTextField jtfSoLuongDau, JTextField jtfSoLuongCuoi, JLabel jlbMessage, JComboBox jcbMaVTu) {
    ...
    public void setEvent(){
        btnSubmit.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(jtfNamThang.getText().length() == 0|| jtfNamThang.getText().equalsIgnoreCase("#null")){
                    ...
                    tonKho.setMaVTu(jcbMaVTu.getItemAt(jcbMaVTu.getSelectedIndex()).toString());
