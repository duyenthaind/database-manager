...
import com.test.testmaven.views.ChiTietDonHangJFrameUpdateNewDonDh;
 ...
 * @author Admin
 */
public class ChiTietDonHangControllerSubList {
    ...
    public ChiTietDonHangControllerSubList(JPanel jpnView, JButton btnAdd, JButton btnRefresh) {
    ...
    public void setDateToTable(String soDhIn){
        List<ChiTietDonHang> listItem = chiTietDonHangService.getListWithInDonDh(soDhIn);
    ...
    public void setEvent(){
        btnAdd.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ChiTietDonHangJFrameUpdateNewDonDh chiTietDonHangJFrame = new ChiTietDonHangJFrameUpdateNewDonDh(new ChiTietDonHang(null, 0, soDh));
                chiTietDonHangJFrame.setTitle("Thông tin chi tiết đơn hàng");
                chiTietDonHangJFrame.setLocationRelativeTo(null);
                chiTietDonHangJFrame.setResizable(false);
                chiTietDonHangJFrame.setVisible(true);
