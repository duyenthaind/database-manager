...
import com.test.testmaven.views.ChiTietDonDatHangJPanel;
import com.test.testmaven.views.DonDatHangJPanel;
 ...
 * @author Admin
 */
public class ChangeWindowDonDhController {
    private JPanel root;
    private String kindSelected = "";
    List<MenuListBean> listItem = null;

    public ChangeWindowDonDhController(JPanel root) {
        this.root = root;
    }
        ...
        public void mouseClicked(MouseEvent e) {
            switch(kind){
                ...
                case "ChiTietDonDatHang":
                    node = new ChiTietDonDatHangJPanel();
                    break;
            }
            root.removeAll();
            root.setLayout(new BorderLayout());
