...
import com.test.testmaven.views.ChiTietPhieuXuatJFrameUpdateNewPxuat;
 ...
 * @author Admin
 */
public class ChiTietPhieuXuatControllerSubList {
    ...
    public ChiTietPhieuXuatControllerSubList(JPanel jpnView, JButton btnAdd, JButton btnRefresh) {
    ...
    public void setDateToTable(String soPxIn){
        List<ChiTietPhieuXuat> listItem = chiTietPhieuXuatService.getListWithInPhieuXuat(soPxIn);
    ...
    public void setEvent(){
        btnAdd.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ChiTietPhieuXuatJFrameUpdateNewPxuat chiTietPhieuXuatJFrame = new ChiTietPhieuXuatJFrameUpdateNewPxuat(new ChiTietPhieuXuat(soPx, null, 0, 0));
