 ...
 * @author Admin
 */
public class ManageChiTietPhieuNhapControllerUpdate {
    ...
    public ManageChiTietPhieuNhapControllerUpdate(JButton btnSubmit, JComboBox jcbSoPn, JComboBox jcbMaVTu, JTextField jtfSoLuongNhap, JTextField jtfDonGiaNhap, JLabel jlbMessage) {
        ...
        btnSubmit.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(jcbMaVTu.getSelectedItem() == null || jcbSoPn.getSelectedItem() == null){
                    ...
                    if(chiTietPhieuNhapService.update(chiTietPhieuNhap)){
