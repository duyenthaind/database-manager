...
import com.test.testmaven.views.ChiTietPhieuNhapJFrameUpdateNewPNhap;
 ...
 * @author Admin
 */
public class ChiTietPhieuNhapControllerSubList {
    ...
    public ChiTietPhieuNhapControllerSubList(JPanel jpnView, JButton btnAdd, JButton btnRefresh) {
    ...
    public void setDateToTable(String soPnIn) {
        List<ChiTietPhieuNhap> listItem = chiTietphieuNhapService.getListWithInPhieuNhap(soPnIn);
    ...
    public void setEvent() {
        btnAdd.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ChiTietPhieuNhapJFrameUpdateNewPNhap chiTietPhieuNhapJFrame = new ChiTietPhieuNhapJFrameUpdateNewPNhap(new ChiTietPhieuNhap(soPn, null, 0, 0));
                chiTietPhieuNhapJFrame.setTitle("Thông tin chi tiết phiếu nhập");
                chiTietPhieuNhapJFrame.setLocationRelativeTo(null);
                chiTietPhieuNhapJFrame.setResizable(false);
                chiTietPhieuNhapJFrame.setVisible(true);
