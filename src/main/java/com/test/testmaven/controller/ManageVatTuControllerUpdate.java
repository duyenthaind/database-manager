 ...
 * @author Admin
 */
public class ManageVatTuControllerUpdate {
    ...
    public ManageVatTuControllerUpdate(JButton btnSubmit, JTextField jtfMaVTu, JTextField jtfTenVTu, JTextField jtfDVTinh, JTextField jtfPhanTram, JLabel jlbMessage) {
        ...
        btnSubmit.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(jtfMaVTu.getText().length() == 0 || jtfMaVTu.getText().equalsIgnoreCase("null")){
                    ...
                    int status = vatTuService.update(vatTu);
                    if(status == 1){
