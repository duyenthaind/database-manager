 ...
 * @author Admin
 */
public class ManageChiTietPhieuXuatControllerUpdate {
    ...
    public ManageChiTietPhieuXuatControllerUpdate(JButton btnSubmit, JComboBox jcbSoPx, JComboBox jcbMaVTu, JTextField jtfSoLuongXuat, JTextField jtfDonGiaXuat, JLabel jlbMessage) {
        ...
        btnSubmit.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(jcbSoPx.getSelectedItem() == null || jcbMaVTu.getSelectedItem() == null){
                    ...
                    if(chiTietPhieuXuatService.update(chiTietPhieuXuat)){
