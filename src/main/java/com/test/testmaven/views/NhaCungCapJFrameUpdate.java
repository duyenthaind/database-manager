...
import com.test.testmaven.controller.ManageNhaCungCapControllerUpdate;

/**
 *
 * @author Admin
 */
public class NhaCungCapJFrameUpdate extends javax.swing.JFrame {

    /**
     * Creates new form NhaCungCapJFrame
     */
    public NhaCungCapJFrameUpdate(NhaCungCap nhaCungCapIn) {
        initComponents();
        ManageNhaCungCapControllerUpdate controller = new ManageNhaCungCapControllerUpdate(btnSubmit, jtfMaNCC, jtfTenNCC, jtfDiaChi, jtfDienThoai, jlbMessage);
